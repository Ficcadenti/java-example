 ...
 *         &lt;element name="NUMERO_PRE_FATTURE_CONTROLLATE">
 *           &lt;simpleType>
...
@XmlType(name = "", propOrder = {
    "header",
    "numeroprefatturecontrollate",
    "prefatturacontrollata"
})
@XmlRootElement(name = "ERP")
public class ERP {

    @XmlElement(name = "HEADER", required = true)
    protected HEADERTYPE header;
    @XmlElement(name = "NUMERO_PRE_FATTURE_CONTROLLATE")
    protected int numeroprefatturecontrollate;
    ...
    /**
     * Recupera il valore della proprietà numeroprefatturecontrollate.
     * 
     */
    public int getNUMEROPREFATTURECONTROLLATE() {
        return numeroprefatturecontrollate;
    }

    /**
     * Imposta il valore della proprietà numeroprefatturecontrollate.
     * 
     */
    public void setNUMEROPREFATTURECONTROLLATE(int value) {
        this.numeroprefatturecontrollate = value;
    }
