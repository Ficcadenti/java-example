 ...
 *           &lt;/simpleType>
 *         &lt;/element>
 *         &lt;element name="DISTINTA" type="{}DISTINTA_DEF_TYPE" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class DEF {
    ...
    protected List<DISTINTADEFTYPE> distinta;
     ...
     * {@link DISTINTADEFTYPE }
     * 
     * 
     */
    public List<DISTINTADEFTYPE> getDISTINTA() {
        if (distinta == null) {
            distinta = new ArrayList<DISTINTADEFTYPE>();
        }
