...
/**
 * <p>Classe Java per PRE_FATTURA_RCP_TYPE complex type.
 * 
 * <p>Il seguente frammento di schema specifica il contenuto previsto contenuto in questa classe.
 * 
 * <pre>
 * &lt;complexType name="PRE_FATTURA_RCP_TYPE">
 *   &lt;complexContent>
 ...
 *           &lt;/simpleType>
 *         &lt;/element>
 *         &lt;element name="DOCUMENTO" type="{}DOCUMENTO_RCP_TYPE" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "PRE_FATTURA_RCP_TYPE", propOrder = {
    "identificativofile",
    "numerodocfatturati",
    "documento"
})
public class PREFATTURARCPTYPE
    extends PREFATTURATYPE
{
    ...
    protected List<DOCUMENTORCPTYPE> documento;
     ...
     * {@link DOCUMENTORCPTYPE }
     * 
     * 
     */
    public List<DOCUMENTORCPTYPE> getDOCUMENTO() {
        if (documento == null) {
            documento = new ArrayList<DOCUMENTORCPTYPE>();
        }
